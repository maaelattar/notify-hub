...
/**
 * Calculated constants derived from base values
 */
export const CALCULATED_CONSTANTS = {
  TIME_INTERVALS: {
    ...
    MS_IN_SECOND: APP_CONSTANTS.TIME.SECOND,
    MS_IN_MINUTE: APP_CONSTANTS.TIME.MINUTE,
    MS_IN_HOUR: APP_CONSTANTS.TIME.HOUR,
    MS_IN_DAY: APP_CONSTANTS.TIME.DAY,
  },

  PERFORMANCE_THRESHOLDS: {
    FAST_OPERATION_MS: APP_CONSTANTS.PERFORMANCE.PERFORMANCE_TOLERANCE_MS / 10, // 100ms
    MEDIUM_OPERATION_MS: APP_CONSTANTS.PERFORMANCE.PERFORMANCE_TOLERANCE_MS / 2, // 500ms
    SLOW_OPERATION_MS: APP_CONSTANTS.PERFORMANCE.PERFORMANCE_TOLERANCE_MS, // 1000ms
  },
} as const;
...
export const ENVIRONMENT_CONSTANTS = {
  DEVELOPMENT: {
    BASE_URL: APP_CONSTANTS.SERVER.LOCAL_BASE_URL,
    CORS_ORIGINS: APP_CONSTANTS.SERVER.DEVELOPMENT_CORS_ORIGINS,
  },

  TEST: {
    DATABASE_URL: 'postgres://test:test@localhost:5433/notifyhub_test',
...
/**
 * Type exports for compile-time checking
 */
export type AppConstantsType = typeof APP_CONSTANTS;
export type CalculatedConstantsType = typeof CALCULATED_CONSTANTS;
export type EnvironmentConstantsType = typeof ENVIRONMENT_CONSTANTS;
